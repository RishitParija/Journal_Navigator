...
def openai_llm(keywords, jif, publisher):
    ...
    system_prompt = (
        f"You are a journal recommender tasked with suggesting suitable journals based on provided research keywords - {keywords}. "
        f"Include journals that have a JIF greater than the given threshold {jif} and belong to any of the specified publishers. "
        f"Focus on including journals that match the keywords closely. "
        f"Present the recommendations in a table with columns: Journal Name, Publisher, JIF."
