...
def openai_llm(keywords, jif, publisher):
    ...
    system_prompt = (
        f"Recommend journals for a research paper based on the keywords provided. Keywords - {keywords}"
        f"Prioritize journals with a JIF higher than {jif} and include only relevant journals from the given list of publishers."
        f"Provide the recommendations in a tabular format"
